  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <header className="mb-8">
        <h1 className="font-headline text-4xl mb-2 text-accent">Member Profile</h1>
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader className="flex flex-col items-center text-center">
          ...
          <CardTitle className="font-headline text-3xl text-accent">John Doe</CardTitle>
          <p className="text-muted-foreground">Member</p>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <h3 className="font-headline text-lg text-accent/80">Contact Information</h3>
            <Separator />
          ...
          <div className="space-y-4">
            <h3 className="font-headline text-lg text-accent/80">Membership Details</h3>
            <Separator />
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div>
